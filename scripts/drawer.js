// scripts/Drawer.js
import { auth, signInWithEmailAndPassword, createUserWithEmailAndPassword, signInWithPhoneNumber, sendSignInLinkToEmail, onAuthStateChanged, signOut } from "https://www.gstatic.com/firebasejs/10.14.1/firebase-auth.js";
import { app, analytics } from "./Firebase-config.js"; // Adjust path based on your project structure

console.log("Drawer.js loading...");

document.addEventListener("DOMContentLoaded", () => {
    console.log("DOM fully loaded, creating drawer...");
    ...
    try {
        ...
        if (!loginBtn || !loginForm || !phoneForm || !userInfo || !emailInput || !passwordInput || !signInBtn || !signUpBtn || !phoneSignInBtn || !phoneInput || !sendCodeBtn || !verificationCode || !verifyCodeBtn) {
            console.error("One or more DOM elements not found:", { loginBtn, loginForm, phoneForm, userInfo, emailInput, passwordInput, signInBtn, signUpBtn, phoneSignInBtn, phoneInput, sendCodeBtn, verificationCode, verifyCodeBtn });
            return;
        }
        ...
        console.error("Error in Drawer.js:", error);
    }
});
